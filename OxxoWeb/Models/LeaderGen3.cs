...
namespace OxxoWeb.Models
{
    public class LeaderGen3
    {
        ...
        // Constructor
        public LeaderGen3(int id_usuario_, int id_plaza_, string nombre_, string apellido_pat_, string apellido_mat_, string foto_, int total_exp_)
        {
